...
from tgbot.keyboards.inline_page import products_item_position_swipe_fp, products_item_category_swipe_fp
        ...
        if split_data[0] in ['buy_category_open']:
            ...
            if get_category is None:
                ...
                if len(get_categories) >= 1:
                    ...
                    await update.callback_query.message.edit_text("<b>🎁 К сожалению, товары в настоящее время отсутствуют.</b>")
                    await update.callback_query.answer("❗ Категория была изменена или удалена")
