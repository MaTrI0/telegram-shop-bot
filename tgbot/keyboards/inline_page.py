...
from tgbot.services.api_sqlite import get_all_categoriesx, get_positionsx
...
def category_edit_swipe_fp(remover):
    ...
    if len(get_categories) <= 10:
        ...
        keyboard.add(
            ...
            ikb("Дальше ➡", callback_data=f"catategory_edit_swipe:{remover + 10}")
        )
...
def position_create_swipe_fp(remover):
    ...
    if len(get_categories) <= 10:
        ...
        keyboard.add(
            ikb(f"🔸 1/{math.ceil(len(get_categories) / 10)} 🔸", callback_data="..."),
            ikb("Дальше ➡", callback_data=f"position_create_swipe:{remover + 10}"),
        )
    elif remover + 10 >= len(get_categories):
        keyboard.add(
...
def position_edit_category_swipe_fp(remover):
    ...
    if len(get_categories) <= 10:
        ...
        keyboard.add(
            ikb(f"🔸 1/{math.ceil(len(get_categories) / 10)} 🔸", callback_data="..."),
            ikb("Дальше ➡", callback_data=f"position_edit_category_swipe:{remover + 10}")
        )
    elif remover + 10 >= len(get_categories):
        keyboard.add(
...
def position_edit_swipe_fp(remover, category_id):
    ...
    for count, a in enumerate(range(remover, len(get_positions))):
        if count < 10:
            keyboard.add(ikb(
                f"{get_positions[a]['position_name']} | {get_positions[a]['position_price']}руб.",
    ...
    if len(get_positions) <= 10:
        ...
        keyboard.add(
            ...
            ikb("Дальше ➡", callback_data=f"position_edit_swipe:{category_id}:{remover + 10}")
        )
...
def products_item_category_swipe_fp(remover):
    ...
    if len(get_categories) <= 10:
        ...
        keyboard.add(
            ikb(f"🔸 1/{math.ceil(len(get_categories) / 10)} 🔸", callback_data="..."),
            ikb("Дальше ➡", callback_data=f"buy_category_swipe:{remover + 10}"),
        )
    elif remover + 10 >= len(get_categories):
        keyboard.add(
...
def products_item_position_swipe_fp(remover, category_id):
    ...
    if len(get_positions) <= 10:
        ...
        keyboard.add(
            ikb(f"🔸 1/{math.ceil(len(get_positions) / 10)} 🔸", callback_data="..."),
            ikb("Дальше ➡", callback_data=f"buy_position_swipe:{category_id}:{remover + 10}"),
        )
    elif remover + 10 >= len(get_positions):
        keyboard.add(
